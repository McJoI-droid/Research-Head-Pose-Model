...
file_path = r'M:\Mediapipe model\attentiveness_detection_RF_7th_verstion_.pkl'
        ...
        while cap.isOpened():
            ...
            try:
                ...
                for i in range(1):
                    ...
                    cv2.putText(image, f'X: {x}', (10, 150 + 30 * i), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1,
                                cv2.LINE_AA)
                    cv2.putText(image, f'Y: {y}', (10, 200 + 30 * i), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1,
                                cv2.LINE_AA)
                    cv2.putText(image, f'Z: {z}', (10, 250 + 30 * i), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1,
                                cv2.LINE_AA)


                with open('1shtsfps.csv', mode='a', newline='') as f:
